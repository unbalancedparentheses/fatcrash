...
pub fn compute_momentum(prices: &[f64], lookback: usize) -> f64 {
    let n = prices.len();
...
pub fn compute_reversal(prices: &[f64], short_lookback: usize, long_lookback: usize) -> f64 {
...
pub fn momentum_score_slice(prices: &[f64], lookback: usize) -> f64 {
    compute_momentum(prices, lookback)
}
...
pub fn momentum_reversal_slice(prices: &[f64], short_lookback: usize, long_lookback: usize) -> f64 {
    compute_reversal(prices, short_lookback, long_lookback)
}
